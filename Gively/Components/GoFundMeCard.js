...
// Memoized UserHeader component (assumed to exist)
const MemoizedUserHeader = memo(UserHeader);

// Memoized LikeButton component (assumed to exist)
const MemoizedLikeButton = memo(LikeButton);

// Memoized LinkPreview wrapper
        ...
        <View style={cardStyles.card}>
            ...
            <View style={styles.footer}>
                ...
                <TouchableOpacity style={styles.shareButton}>
                    <Text style={styles.shareButtonText}>Share GoFundMe</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
